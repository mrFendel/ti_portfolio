...
for ticker in tqdm(tickers):
    ...
    pair_df['spread'] = pair_df['ts1'] - pair_df['ts2']  # spread
    ...
    fig, ax = plt.subplots(3, 1, figsize=(12, 15), gridspec_kw={'height_ratios': [4, 2, 2]})
    ...
    ax[0].legend()
    ax[1].plot(pair_df['spread'].values,
               label='spread')
    ax[1].legend()
    ax[2].plot(pair_df['err'], label=f'a = {a}, t = {t}, b = {b}')
    ax[2].legend()
    plt.show()
